...
- Treat `reports/sessions/*.md` and `obsidian_vault/**/*.md` as user learning records and do not commit them.
...
- Use SQLite as the source of truth and Obsidian Markdown as the default readable notebook.
